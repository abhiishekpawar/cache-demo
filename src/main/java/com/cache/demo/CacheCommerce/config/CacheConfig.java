package com.cache.demo.CacheCommerce.config;
...
public class CacheConfig {
    ...
    public CacheManager redisCacheManager(RedisConnectionFactory redisConnectionFactory) {
        RedisCacheConfiguration redisCacheConfiguration = RedisCacheConfiguration.defaultCacheConfig()
                ...
                .enableTimeToIdle(); //resets TTL for frequently accessed key.

        //cache config per key
        Map<String, RedisCacheConfiguration> cacheMap = new HashMap<>();
        cacheMap.put("all_products", RedisCacheConfiguration
                .defaultCacheConfig().entryTtl(Duration.ofMinutes(10)));
        cacheMap.put("products", RedisCacheConfiguration
